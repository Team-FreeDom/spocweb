        ...
        <div class="row">
            ...
            <div class="col-md-10 col-xs-10">
                        	...
                        	<div class="col-md-12 col-xs-12">
                                <form action="search.do" method="post" class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="membername" class="form-control" id="exampleInputName2" placeholder="姓名">
                                    </div>
                        ...
                        <div id="tableBox">
                            ...
                            <form action="deleteMember.do" method="post" name="myform" id="myform">
                                <table class="table" id="tabBox">
                                   ...
                                   <c:forEach items='${students}' var="student">
                                    <tr>
                                        <td><label><input type="checkbox" name="student" value="${student.loginid}" id="student" class="ck"/></label></td>
                    
                                        <td>${student.name}</td>
                                        <td>${student.sex}</td>
                                        <td>${student.college}</td>
                                        <td>${student.grade}</td>
                                        <td colspan="2"><a id="${student.loginid}" class="detail" href="#">查看详情</a>
                                          <a  style="margin-left:20px;" data-toggle="modal" data-target=".bs-example-modal-lg" href="#">
                        ...
                        <c:forEach items='${students}' var="student"> 
                        <div id="${student.loginid}a" style="display:none;position:absolute;margin:0 auto;width:600px;height:400px;">
                          <table>
                            <tr>
                               <td>姓名</td>
                               <td>性别</td>
                             ...
                             <tr>
                              ...
                              <td>${student.college}</td>
                              <td>${student.grade}</td>
                              <td><img src="${student.img}" width=100px height=100px></img></td>
                            </tr>
                          </table>
                        </div>
                        </c:forEach>
