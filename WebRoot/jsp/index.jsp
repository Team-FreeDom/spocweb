			...
			.ready(
					function() {
						...
						function teamContent() {
							//oTeamContent3
							var oTeamContent3 = document
									.getElementById("teamContent3");
							...
							function create() {
								...
								for (var i = 0; i < 8; i++) {
									...
									oLi.style.backgroundPosition = -(i * w)
											+ 'px 0';
									oUl.appendChild(oLi);
								}
								...
								timer1 = setInterval(
										function() {
											...
											for (var i = 0; i < setArr.length; i++) {
												...
												setArr[i].x = setArr[i].startX
														- Math
																.sin(setArr[i].num
																		* Math.PI
																		/ 180)
														* setArr[i].step;
												setArr[i].y = setArr[i].startY
														- (setArr[i].num
																* Math.PI / 180)
														* setArr[i].step;
...
<body>
	...
	<div id="fullpage">
						...
						<div id="full" class="carousel slide">
							<div class="carousel-inner">
								<ul class="row item active">
									<li class="col-xs-3 col-md-3"><a href="#"><img
											src="../image/1.jpg" class="img-responsive img-thumbnail"></a>
									</li>
									<li class="col-xs-3 col-md-3"><img src="../image/2.jpg"
										class="img-responsive img-thumbnail"></li>
									<li class="col-xs-3 col-md-3"><img src="../image/3.jpg"
										class="img-responsive img-thumbnail"></li>
									<li class="col-xs-3 col-md-3"><img src="../image/3.jpg"
										class="img-responsive img-thumbnail"></li>
								</ul>
								<ul class="row item">
									<li class="col-xs-3"><img src="../image/4.jpg"
										class="img-responsive img-thumbnail"></li>
									<li class="col-xs-3"><img src="../image/5.jpg"
										class="img-responsive img-thumbnail"></li>
									<li class="col-xs-3"><img src="../image/1.jpg"
										class="img-responsive img-thumbnail"></li>
									<li class="col-xs-3"><img src="../image/1.jpg"
										class="img-responsive img-thumbnail"></li>
								</ul>
			...
			<div class="container" id="turn_picture">
				...
				<ul>
					<li><a href="#" data-toggle="tooltip"
						title="漩涡鸣人！日本漫画家岸本齐史作品《火影忍者》中男主角。因为身上封印着邪恶的九尾妖狐，无父无母的他受尽了村人的冷眼与歧视，他下定决心要成为第六代火影，让所有人都认同他的存在">
							<div>
								<img alt="" src="../image/images/wangye_03.gif" width="150px" />
							</div>
							<div>
								<h3>摄影组</h3>
							</div>
					...
					<li><a href="#" data-toggle="tooltip"
						title="蒙奇·D·路飞 是日本人气动漫 《海贼王》中的主人公。是日本人气动漫 《海贼王》中的主人公。草帽海贼团船长，梦想是找到传说中的宝藏 —— ONE PIECE，成为海贼王。">
							<div>
					...
					<li><a href="#" data-toggle="tooltip"
						title="日向雏田！ 日本漫画家岸本齐史作品《火影忍者》中的3号女主角。木叶忍者村的女忍者，木叶名门日向一族宗家族长的长女。喜欢漩涡鸣人，原本是个性格柔弱的女孩，但是在鸣人的影响下逐渐变得坚强，并逐渐成长为一名优秀的忍者。在">
							<div>
								<img alt="" src="../image/images/wangye_07.gif" width="150px" />
							</div>
							<div>
								<h3>动画组</h3>
							</div>
			...
			<div class="isolayer isolayer--deco4">
				<ul class="grid">
					<li class="grid__item">
						...
						data-target="#myModal"><div class="layer"></div>
							<div class="layer"></div>
							<div class="layer"></div>
							<img class="grid__img layer" src="../img/Dribbble/2.gif" alt="01" />
					</a>
					</li>
					<li class="grid__item"><a class="grid__link" href="#"
						data-toggle="modal" data-target="#myModal"><div class="layer"></div>
							<div class="layer"></div>
							<div class="layer"></div>
							<img class="grid__img layer" src="../img/Dribbble/3.gif" alt="02" /></a>
					</li>
					<li class="grid__item"><a class="grid__link" href="#"><div
								class="layer"></div>
							<div class="layer"></div>
							<div class="layer"></div>
							<img class="grid__img layer" src="../img/Dribbble/4.gif" alt="03" /></a>
					</li>
					<li class="grid__item"><a class="grid__link" href="#"><div
								class="layer"></div>
							<div class="layer"></div>
							<div class="layer"></div>
							<img class="grid__img layer" src="../img/Dribbble/4.png" alt="04" /></a>
					</li>
					<li class="grid__item"><a class="grid__link" href="#"><div
								class="layer"></div>
							<div class="layer"></div>
							<div class="layer"></div>
							<img class="grid__img layer" src="../img/Dribbble/5.png" alt="05" /></a>
					</li>
					<li class="grid__item"><a class="grid__link" href="#"><div
								class="layer"></div>
							<div class="layer"></div>
							<div class="layer"></div>
							<img class="grid__img layer" src="../img/Dribbble/2.gif" alt="06" /></a>
					</li>
					<li class="grid__item"><a class="grid__link" href="#"><div
								class="layer"></div>
							<div class="layer"></div>
							<div class="layer"></div>
							<img class="grid__img layer" src="../img/Dribbble/7.png" alt="07" /></a>
					</li>
					<li class="grid__item"><a class="grid__link" href="#"><div
								class="layer"></div>
							<div class="layer"></div>
							<div class="layer"></div>
							<img class="grid__img layer" src="../img/Dribbble/8.png" alt="08" /></a>
					</li>
					<li class="grid__item"><a class="grid__link" href="#"><div
								class="layer"></div>
							<div class="layer"></div>
							<div class="layer"></div>
							<img class="grid__img layer" src="../img/Dribbble/9.png" alt="09" /></a>
					</li>
				</ul>
			</div>
		</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-2 col-xs-2" id="fourth">
							...
							<a type="button" class="btn btn-danger" href="list2.html"
		...
		<div class="section">
			<div class="slide">
				<div
					style="position:relative; top:5%;overflow:hidden; min-height:320px; height:100%;">
					<div id="list">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<video id="example_video_2" class="video-js vjs-default-skin"
						...
						poster="http://video-js.zencoder.com/oceans-clip.png"
						data-setup="{}">
						<source id="1" src="http://vjs.zencdn.net/v/oceans.mp4"
							type='video/mp4' />
						<source src="http://vjs.zencdn.net/v/oceans.webm"
							type='video/webm' />
